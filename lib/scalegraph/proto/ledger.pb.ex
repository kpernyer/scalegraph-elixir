...
defmodule Scalegraph.Proto.CreateParticipantRequest do
  ...
  field(:metadata, 4,
    repeated: true,
    type: Scalegraph.Proto.CreateParticipantRequest.MetadataEntry,
    map: true
  )
end
...
defmodule Scalegraph.Proto.CreateParticipantAccountRequest do
  ...
  field(:metadata, 4,
    repeated: true,
    type: Scalegraph.Proto.CreateParticipantAccountRequest.MetadataEntry,
    map: true
  )
end
...
defmodule Scalegraph.Proto.AddServiceRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Scalegraph.Proto.RemoveServiceRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Scalegraph.Proto.ListServicesRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Scalegraph.Proto.ListServicesResponse do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Scalegraph.Proto.CreateAccountRequest do
  ...
  field(:metadata, 3,
    repeated: true,
    type: Scalegraph.Proto.CreateAccountRequest.MetadataEntry,
    map: true
  )
end
...
defmodule Scalegraph.Proto.ParticipantService.Service do
  @moduledoc false
  use GRPC.Service,
    name: "scalegraph.ledger.ParticipantService",
  ...
  rpc(
    :ListParticipants,
    Scalegraph.Proto.ListParticipantsRequest,
    Scalegraph.Proto.ListParticipantsResponse
  )

  rpc(
    :CreateParticipantAccount,
    Scalegraph.Proto.CreateParticipantAccountRequest,
    Scalegraph.Proto.Account
  )

  rpc(
    :GetParticipantAccounts,
    Scalegraph.Proto.GetParticipantAccountsRequest,
    Scalegraph.Proto.GetParticipantAccountsResponse
  )

  rpc(:AddService, Scalegraph.Proto.AddServiceRequest, Scalegraph.Proto.Participant)
  rpc(:RemoveService, Scalegraph.Proto.RemoveServiceRequest, Scalegraph.Proto.Participant)
  rpc(:ListServices, Scalegraph.Proto.ListServicesRequest, Scalegraph.Proto.ListServicesResponse)
end
...
defmodule Scalegraph.Proto.LedgerService.Service do
  ...
  rpc(
    :ListTransactions,
    Scalegraph.Proto.ListTransactionsRequest,
    Scalegraph.Proto.ListTransactionsResponse
  )
end
...
defmodule Scalegraph.Proto.CreateLoanRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  field(:lender_id, 1, type: :string)
  field(:borrower_id, 2, type: :string)
  field(:amount, 3, type: :int64)
  field(:reference, 4, type: :string)
end

defmodule Scalegraph.Proto.RepayLoanRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Scalegraph.Proto.GetOutstandingLoansRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Scalegraph.Proto.GetOutstandingLoansResponse do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  field(:lender_id, 1, type: :string)
  field(:total_outstanding, 2, type: :int64)
end

defmodule Scalegraph.Proto.GetTotalDebtRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  field(:borrower_id, 1, type: :string)
end

defmodule Scalegraph.Proto.GetTotalDebtResponse do
  @moduledoc false
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  field(:borrower_id, 1, type: :string)
  field(:total_debt, 2, type: :int64)
end
...
defmodule Scalegraph.Proto.BusinessService.Service do
  ...
  rpc(
    :PurchaseInvoice,
    Scalegraph.Proto.PurchaseInvoiceRequest,
    Scalegraph.Proto.BusinessTransactionResponse
  )

  rpc(
    :PayInvoice,
    Scalegraph.Proto.PayInvoiceRequest,
    Scalegraph.Proto.BusinessTransactionResponse
  )

  rpc(
    :AccessPayment,
    Scalegraph.Proto.AccessPaymentRequest,
    Scalegraph.Proto.BusinessTransactionResponse
  )

  rpc(
    :CreateLoan,
    Scalegraph.Proto.CreateLoanRequest,
    Scalegraph.Proto.BusinessTransactionResponse
  )

  rpc(
    :RepayLoan,
    Scalegraph.Proto.RepayLoanRequest,
    Scalegraph.Proto.BusinessTransactionResponse
  )

  rpc(
    :GetOutstandingLoans,
    Scalegraph.Proto.GetOutstandingLoansRequest,
    Scalegraph.Proto.GetOutstandingLoansResponse
  )

  rpc(
    :GetTotalDebt,
    Scalegraph.Proto.GetTotalDebtRequest,
    Scalegraph.Proto.GetTotalDebtResponse
  )
end
